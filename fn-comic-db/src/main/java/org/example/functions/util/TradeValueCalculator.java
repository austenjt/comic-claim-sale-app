...
public final class TradeValueCalculator {
    ...
    static {
        ...
        MULTIPLIERS.put(ComicGrade.VERY_FINE_NEAR_MINT, new BigDecimal("0.60"));
        MULTIPLIERS.put(ComicGrade.VERY_FINE_PLUS,    new BigDecimal("0.50"));
        MULTIPLIERS.put(ComicGrade.VERY_FINE,         new BigDecimal("0.30"));
        MULTIPLIERS.put(ComicGrade.VERY_FINE_MINUS,   new BigDecimal("0.24"));
        MULTIPLIERS.put(ComicGrade.FINE_VERY_FINE,    new BigDecimal("0.18"));
        MULTIPLIERS.put(ComicGrade.FINE_PLUS,         new BigDecimal("0.15"));
        MULTIPLIERS.put(ComicGrade.FINE,              new BigDecimal("0.12"));
        MULTIPLIERS.put(ComicGrade.FINE_MINUS,        new BigDecimal("0.10"));
        MULTIPLIERS.put(ComicGrade.VERY_GOOD_FINE,    new BigDecimal("0.08"));
        MULTIPLIERS.put(ComicGrade.VERY_GOOD_PLUS,    new BigDecimal("0.08"));
        MULTIPLIERS.put(ComicGrade.VERY_GOOD,         new BigDecimal("0.06"));
        MULTIPLIERS.put(ComicGrade.VERY_GOOD_MINUS,   new BigDecimal("0.06"));
        MULTIPLIERS.put(ComicGrade.GOOD_VERY_GOOD,    new BigDecimal("0.04"));
        MULTIPLIERS.put(ComicGrade.GOOD_PLUS,         new BigDecimal("0.04"));
        MULTIPLIERS.put(ComicGrade.GOOD,              new BigDecimal("0.02"));
        MULTIPLIERS.put(ComicGrade.GOOD_MINUS,        new BigDecimal("0.01"));
