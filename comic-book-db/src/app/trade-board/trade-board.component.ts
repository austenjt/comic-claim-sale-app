...
const GRADE_OPTIONS: GradeOption[] = [
  { value: 10.0, label: '10.0 — Gem Mint',          multiplier: 1.50 },
  { value:  9.9, label:  '9.9 — Mint',               multiplier: 1.40 },
  ...
  { value:  9.2, label:  '9.2 — Near Mint-',         multiplier: 0.90 },
  { value:  9.0, label:  '9.0 — Very Fine/Near Mint', multiplier: 0.80 },
  { value:  8.5, label:  '8.5 — Very Fine+',         multiplier: 0.70 },
  { value:  8.0, label:  '8.0 — Very Fine',          multiplier: 0.60 },
  { value:  7.5, label:  '7.5 — Very Fine-',         multiplier: 0.50 },
  { value:  7.0, label:  '7.0 — Fine/Very Fine',     multiplier: 0.45 },
  { value:  6.5, label:  '6.5 — Fine+',              multiplier: 0.40 },
  { value:  6.0, label:  '6.0 — Fine',               multiplier: 0.35 },
  { value:  5.5, label:  '5.5 — Fine-',              multiplier: 0.30 },
  { value:  5.0, label:  '5.0 — Very Good/Fine',     multiplier: 0.25 },
  { value:  4.5, label:  '4.5 — Very Good+',         multiplier: 0.22 },
  { value:  4.0, label:  '4.0 — Very Good',          multiplier: 0.20 },
  { value:  3.5, label:  '3.5 — Very Good-',         multiplier: 0.18 },
  { value:  3.0, label:  '3.0 — Good/Very Good',     multiplier: 0.15 },
  { value:  2.5, label:  '2.5 — Good+',              multiplier: 0.13 },
  { value:  2.0, label:  '2.0 — Good',               multiplier: 0.11 },
  { value:  1.8, label:  '1.8 — Good-',              multiplier: 0.09 },
  { value:  1.5, label:  '1.5 — Fair/Good',          multiplier: 0.07 },
  { value:  1.0, label:  '1.0 — Fair',               multiplier: 0.06 },
  { value:  0.5, label:  '0.5 — Poor',               multiplier: 0.05 },
];
