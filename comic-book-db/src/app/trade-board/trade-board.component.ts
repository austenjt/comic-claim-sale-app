...
const GRADE_OPTIONS: GradeOption[] = [
  ...
  { value:  9.0, label:  '9.0 — Very Fine/Near Mint', multiplier: 0.60 },
  { value:  8.5, label:  '8.5 — Very Fine+',         multiplier: 0.50 },
  { value:  8.0, label:  '8.0 — Very Fine',          multiplier: 0.30 },
  { value:  7.5, label:  '7.5 — Very Fine-',         multiplier: 0.24 },
  { value:  7.0, label:  '7.0 — Fine/Very Fine',     multiplier: 0.18 },
  { value:  6.5, label:  '6.5 — Fine+',              multiplier: 0.15 },
  { value:  6.0, label:  '6.0 — Fine',               multiplier: 0.12 },
  { value:  5.5, label:  '5.5 — Fine-',              multiplier: 0.10 },
  { value:  5.0, label:  '5.0 — Very Good/Fine',     multiplier: 0.08 },
  { value:  4.5, label:  '4.5 — Very Good+',         multiplier: 0.08 },
  { value:  4.0, label:  '4.0 — Very Good',          multiplier: 0.06 },
  { value:  3.5, label:  '3.5 — Very Good-',         multiplier: 0.06 },
  { value:  3.0, label:  '3.0 — Good/Very Good',     multiplier: 0.04 },
  { value:  2.5, label:  '2.5 — Good+',              multiplier: 0.04 },
  { value:  2.0, label:  '2.0 — Good',               multiplier: 0.02 },
  { value:  1.8, label:  '1.8 — Good-',              multiplier: 0.01 },
